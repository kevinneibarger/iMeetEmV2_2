package com.android.imeetem.fbphotopicker;
...
import com.android.imeetem.UpdateProfileActivity;
                    ...
                    try {
                        ...
                        mPhotosGrid.setOnItemClickListener(new OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position,
                                ...
                                prefs.edit().putString("photoUrl", mPhotos.get(position).getSource()).commit();
                                Intent i = new Intent(view.getContext(), UpdateProfileActivity.class);
